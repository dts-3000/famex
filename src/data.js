export const CELEBRITIES = [
  { id:'tayswift',      name:'Taylor Swift',     emoji:'🎤', sector:'Music',    basePrice:22.00, volatility:0.035, buzzBase:88, buzzDecayRate:0.92 },
  { id:'beyonce',       name:'Beyoncé',           emoji:'👑', sector:'Music',    basePrice:28.00, volatility:0.030, buzzBase:85, buzzDecayRate:0.91 },
  { id:'adele',         name:'Adele',             emoji:'🎵', sector:'Music',    basePrice:19.00, volatility:0.025, buzzBase:78, buzzDecayRate:0.90 },
  { id:'edsheeran',     name:'Ed Sheeran',        emoji:'🎸', sector:'Music',    basePrice:16.00, volatility:0.028, buzzBase:75, buzzDecayRate:0.90 },
  ...
  { id:'idriselba',     name:'Idris Elba',        emoji:'🎭', sector:'Film & TV', basePrice:12.50, volatility:0.014, buzzBase:67, buzzDecayRate:0.99 },
  { id:'judidench',     name:'Judi Dench',        emoji:'🎩', sector:'Film & TV', basePrice:12.00, volatility:0.022, buzzBase:22, buzzDecayRate:0.97 },
  { id:'barrykeoghan',  name:'Barry Keoghan',     emoji:'🌟', sector:'Film & TV', basePrice:11.50, volatility:0.028, buzzBase:24, buzzDecayRate:0.89 },
  ...
  { id:'caitlinclark',  name:'Caitlin Clark',     emoji:'🏀', sector:'Sport',    basePrice:19.50, volatility:0.048, buzzBase:23, buzzDecayRate:0.91 },
  ...
  { id:'trump',         name:'Donald Trump',      emoji:'🇺🇸', sector:'Politics', basePrice:15.00, volatility:0.025, buzzBase:15, buzzDecayRate:0.95 },
  { id:'albanese',      name:'Anthony Albanese',  emoji:'🇦🇺', sector:'Politics', basePrice:13.00, volatility:0.042, buzzBase:14, buzzDecayRate:0.89 },
  { id:'nigelfar',      name:'Nigel Farage',      emoji:'🍺', sector:'Politics', basePrice:12.00, volatility:0.065, buzzBase:18, buzzDecayRate:0.90 },
  ...
  { id:'elonmusk',      name:'Elon Musk',         emoji:'🚀', sector:'Tech',     basePrice:21.00, volatility:0.075, buzzBase:12, buzzDecayRate:0.93 },
  { id:'melgibson',     name:'Mel Gibson',        emoji:'🎭', sector:'Film & TV',basePrice:11.00, volatility:0.038, buzzBase:10, buzzDecayRate:0.91 },
  { id:'charleskoen', name:'King Charles',      emoji:'👑', sector:'Royals',   basePrice:16.50, volatility:0.022, buzzBase:68, buzzDecayRate:0.88 },
  { id:'timcook',     name:'Tim Cook',          emoji:'🍎', sector:'Tech',     basePrice:16.00, volatility:0.035, buzzBase:15, buzzDecayRate:0.88 },
...
{ id:'arianagrande',   name:'Ariana Grande',      emoji:'🌙', sector:'Music',    basePrice:12.00, volatility:0.035, buzzBase:86, buzzDecayRate:0.92 },
{ id:'justinbieber',   name:'Justin Bieber',      emoji:'🎤', sector:'Music',    basePrice:13.00, volatility:0.038, buzzBase:76, buzzDecayRate:0.90 },
{ id:'kanyewest',      name:'Kanye West',         emoji:'🎭', sector:'Music',    basePrice:10.00, volatility:0.095, buzzBase:85, buzzDecayRate:0.93 },
...
{ id:'dwaynejo',       name:'Dwayne Johnson',     emoji:'💪', sector:'Film & TV', basePrice:12.00, volatility:0.035, buzzBase:85, buzzDecayRate:0.91 },
...
{ id:'cristianoron',   name:'Cristiano Ronaldo',  emoji:'⚽', sector:'Sport',    basePrice:18.00, volatility:0.045, buzzBase:90, buzzDecayRate:0.92 },
{ id:'leomessi',       name:'Lionel Messi',       emoji:'🐐', sector:'Sport',    basePrice:16.00, volatility:0.040, buzzBase:89, buzzDecayRate:0.92 },
{ id:'lebron',         name:'LeBron James',       emoji:'👑', sector:'Sport',    basePrice:15.00, volatility:0.042, buzzBase:88, buzzDecayRate:0.92 },
...
{ id:'rogerfederer',   name:'Roger Federer',      emoji:'🎾', sector:'Sport',    basePrice:15.00, volatility:0.022, buzzBase:15, buzzDecayRate:0.89 },
...
{ id:'jeffbezos',      name:'Jeff Bezos',         emoji:'📦', sector:'Tech',     basePrice:28.00, volatility:0.060, buzzBase:12, buzzDecayRate:0.91 },
{ id:'markzuckerberg', name:'Mark Zuckerberg',    emoji:'🤖', sector:'Tech',     basePrice:26.00, volatility:0.065, buzzBase:10, buzzDecayRate:0.91 },
{ id:'billgates',      name:'Bill Gates',         emoji:'💻', sector:'Tech',     basePrice:24.00, volatility:0.040, buzzBase:18, buzzDecayRate:0.90 },
{ id:'samaltman',      name:'Sam Altman',         emoji:'🤯', sector:'Tech',     basePrice:22.00, volatility:0.070, buzzBase:18, buzzDecayRate:0.91 },
{ id:'nickiminaj',     name:'Nicki Minaj',        emoji:'👸', sector:'Music',    basePrice:14.00, volatility:0.055, buzzBase:80, buzzDecayRate:0.91 },
{ id:'badbunny',       name:'Bad Bunny',          emoji:'🐰', sector:'Music',    basePrice:17.00, volatility:0.040, buzzBase:82, buzzDecayRate:0.91 },
{ id:'charliexcx',     name:'Charli XCX',         emoji:'⚡', sector:'Music',    basePrice:11.00, volatility:0.045, buzzBase:80, buzzDecayRate:0.91 },
{ id:'cateblanchett',  name:'Cate Blanchett',     emoji:'🏆', sector:'Film & TV', basePrice:14.00, volatility:0.022, buzzBase:74, buzzDecayRate:0.89 },
...
{ id:'chrisevans',     name:'Chris Evans',        emoji:'🛡️', sector:'Film & TV', basePrice:15.00, volatility:0.030, buzzBase:99, buzzDecayRate:0.90 },
{ id:'robertdowney',   name:'Robert Downey Jr',   emoji:'🦾', sector:'Film & TV', basePrice:18.00, volatility:0.035, buzzBase:32, buzzDecayRate:0.91 },
{ id:'annehathaway',   name:'Anne Hathaway',      emoji:'👒', sector:'Film & TV', basePrice:12.00, volatility:0.026, buzzBase:33, buzzDecayRate:0.89 },
{ id:'reesewitherspoon',name:'Reese Witherspoon', emoji:'🌸', sector:'Film & TV', basePrice:11.00, volatility:0.025, buzzBase:32, buzzDecayRate:0.89 },
{ id:'keanugreeves',   name:'Keanu Reeves',       emoji:'🕶️', sector:'Film & TV', basePrice:14.00, volatility:0.025, buzzBase:36, buzzDecayRate:0.90 },
{ id:'neymarjr',       name:'Kylian Mbappé',      emoji:'⚡', sector:'Sport',    basePrice:10.00, volatility:0.045, buzzBase:36, buzzDecayRate:0.92 },
{ id:'erling',         name:'Erling Haaland',     emoji:'🎯', sector:'Sport',    basePrice:18.00, volatility:0.042, buzzBase:34, buzzDecayRate:0.91 },
{ id:'anthonyjoshua',  name:'Anthony Joshua',     emoji:'🥊', sector:'Sport',    basePrice:22.00, volatility:0.048, buzzBase:36, buzzDecayRate:0.90 },
{ id:'tysonfury',      name:'Tyson Fury',         emoji:'👊', sector:'Sport',    basePrice:24.00, volatility:0.055, buzzBase:38, buzzDecayRate:0.90 },
{ id:'stephanicurry',  name:'Stephen Curry',      emoji:'🏀', sector:'Sport',    basePrice:26.00, volatility:0.038, buzzBase:30, buzzDecayRate:0.90 },
...
{ id:'princeedward',   name:'Prince Edward',      emoji:'🎩', sector:'Royals',   basePrice:12.00, volatility:0.015, buzzBase:39, buzzDecayRate:0.87 },
{ id:'princessanne',   name:'Princess Anne',      emoji:'🐴', sector:'Royals',   basePrice:13.00, volatility:0.015, buzzBase:30, buzzDecayRate:0.97 },
{ id:'paloalto',       name:'Jensen Huang',       emoji:'💻', sector:'Tech',     basePrice:20.00, volatility:0.025, buzzBase:18, buzzDecayRate:0.99 },
{ id:'jackdorsey',     name:'Jack Dorsey',        emoji:'🐦', sector:'Tech',     basePrice:16.00, volatility:0.025, buzzBase:19, buzzDecayRate:0.98 },
{ id:'serjobrin',      name:'Sergey Brin',        emoji:'🔍', sector:'Tech',     basePrice:18.00, volatility:0.020, buzzBase:19, buzzDecayRate:0.98 },
{ id:'nickdaicos',      name:'Nick Daicos',        emoji:'🎯', sector:'Sport',   basePrice:15.00, volatility:0.020, buzzBase:15, buzzDecayRate:0.98 },
{ id:'baileysmith',      name:'Bailey Smith',        emoji:'🎯', sector:'Sport',   basePrice:15.00, volatility:0.020, buzzBase:15, buzzDecayRate:0.98 },
{ id:'kateperry',       name:'Kate Perry',          emoji:'🐰', sector:'Music',    basePrice:17.00, volatility:0.040, buzzBase:39, buzzDecayRate:0.91 },
{ id:'yunglean',     name:'Yung Lean',         emoji:'⚡', sector:'Music',    basePrice:11.00, volatility:0.045, buzzBase:70, buzzDecayRate:0.91 },
]
...
export const NEWS_TEMPLATES = [
  ...
  { tmpl:(n)=>`Critics pan ${n}'s latest project`,               buzzImpact:-14,  dir:-1, pub:'The Telegraph' },
  { tmpl:(n)=>`${n} goes quiet — fans concerned`,                buzzImpact:-13,  dir:-1, pub:'Reuters' },
  { tmpl:(n)=>`${n} seen leaving controversial event`,           buzzImpact:-12,  dir:-1, pub:'Daily Mail' },
  { tmpl:(n)=>`${n} writes scandalous tell-all book`,            buzzImpact:-18,  dir:-1, pub:'Herald Sun' },
  { tmpl:(n)=>`${n} secretly recorded in expose`,                buzzImpact:-18,  dir:-1, pub:'Daily Mail' },
  { tmpl:(n)=>`${n} wins humanitarian award`,                    buzzImpact:+22,  dir:1, pub:'Daily Mail' },
  { tmpl:(n)=>`${n} donates to local charity`,                   buzzImpact:+21,  dir:1, pub:'The Sun' },
  ...
  { tmpl:(n)=>`${n} signs new marketing deal`,                   buzzImpact:+14,  dir:1, pub:'New York Times' },
  { tmpl:(n)=>`${n} spotted at celebrity rehab facility`,          buzzImpact:-14, dir:-1, pub:'The Sun' },
  { tmpl:(n)=>`${n} in explosive row with former friend`,          buzzImpact:-12, dir:-1, pub:'Daily Mirror' },
  { tmpl:(n)=>`${n} cancels world tour with no explanation`,       buzzImpact:-14, dir:-1, pub:'BBC News' },
  { tmpl:(n)=>`${n} slammed for out of touch comments`,            buzzImpact:-12, dir:-1, pub:'The Guardian' },
  { tmpl:(n)=>`${n} involved in shock legal battle`,               buzzImpact:-12, dir:-1, pub:'The Times' },
  ...
  { tmpl:(n)=>`${n} labelled hypocrite after leaked messages`,     buzzImpact:-12, dir:-1, pub:'The Telegraph' },
  { tmpl:(n)=>`${n} hit with shock tax evasion allegations`,       buzzImpact:-14, dir:-1, pub:'Financial Times' },
