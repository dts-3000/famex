export const CELEBRITIES = [
  ...
  { id:'trump',         name:'Donald Trump',      emoji:'🇺🇸', sector:'Politics', basePrice:15.00, volatility:0.025, buzzBase:75, buzzDecayRate:0.95 },
  ...
  { id:'elonmusk',      name:'Elon Musk',         emoji:'🚀', sector:'Tech',     basePrice:21.00, volatility:0.075, buzzBase:72, buzzDecayRate:0.93 },
  { id:'melgibson',     name:'Mel Gibson',        emoji:'🎭', sector:'Film & TV',basePrice:11.00, volatility:0.038, buzzBase:80, buzzDecayRate:0.91 },
...
{ id:'rogerfederer',   name:'Roger Federer',      emoji:'🎾', sector:'Sport',    basePrice:15.00, volatility:0.022, buzzBase:75, buzzDecayRate:0.89 },
...
{ id:'paloalto',       name:'Jensen Huang',       emoji:'💻', sector:'Tech',     basePrice:20.00, volatility:0.025, buzzBase:38, buzzDecayRate:0.99 },
{ id:'jackdorsey',     name:'Jack Dorsey',        emoji:'🐦', sector:'Tech',     basePrice:16.00, volatility:0.025, buzzBase:39, buzzDecayRate:0.98 },
{ id:'serjobrin',      name:'Sergey Brin',        emoji:'🔍', sector:'Tech',     basePrice:18.00, volatility:0.020, buzzBase:39, buzzDecayRate:0.98 },
{ id:'nickdaicos',      name:'Nick Daicos',        emoji:'🎯', sector:'Sport',   basePrice:15.00, volatility:0.020, buzzBase:35, buzzDecayRate:0.98 },
{ id:'baileysmith',      name:'Bailey Smith',        emoji:'🎯', sector:'Sport',   basePrice:15.00, volatility:0.020, buzzBase:35, buzzDecayRate:0.98 },
