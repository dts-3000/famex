export const CELEBRITIES = [
  { id:'tayswift',      name:'Taylor Swift',     emoji:'🎤', sector:'Music',    basePrice:420, volatility:0.035, buzzBase:88, buzzDecayRate:0.92 },
  { id:'beyonce',       name:'Beyoncé',           emoji:'👑', sector:'Music',    basePrice:380, volatility:0.030, buzzBase:85, buzzDecayRate:0.91 },
  { id:'adele',         name:'Adele',             emoji:'🎵', sector:'Music',    basePrice:290, volatility:0.025, buzzBase:78, buzzDecayRate:0.90 },
  { id:'edsheeran',     name:'Ed Sheeran',        emoji:'🎸', sector:'Music',    basePrice:260, volatility:0.028, buzzBase:75, buzzDecayRate:0.90 },
  { id:'dualipa',       name:'Dua Lipa',          emoji:'💃', sector:'Music',    basePrice:240, volatility:0.032, buzzBase:80, buzzDecayRate:0.91 },
  ...
  { id:'emmastone',     name:'Emma Stone',        emoji:'🎬', sector:'Film & TV', basePrice:200, volatility:0.026, buzzBase:70, buzzDecayRate:0.89 },
  ...
  { id:'elonmusk',      name:'Elon Musk',         emoji:'🚀', sector:'Tech',     basePrice:310, volatility:0.175, buzzBase:10, buzzDecayRate:0.13 },
  { id:'damiansmith',   name:'Damian Smith',      emoji:'🚀', sector:'Tech',     basePrice:10, volatility:0.015, buzzBase:10, buzzDecayRate:0.13 },
]
