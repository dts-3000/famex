export const CELEBRITIES = [
  ...
  { id:'adele',         name:'Adele',             emoji:'🎵', sector:'Music',    basePrice:19.00, volatility:0.025, buzzBase:42, buzzDecayRate:0.90 }, // ~20-50/wk
  { id:'edsheeran',     name:'Ed Sheeran',        emoji:'🎸', sector:'Music',    basePrice:16.00, volatility:0.028, buzzBase:40, buzzDecayRate:0.90 }, // ~20-50/wk
  { id:'dualipa',       name:'Dua Lipa',          emoji:'💃', sector:'Music',    basePrice:14.00, volatility:0.032, buzzBase:45, buzzDecayRate:0.91 }, // ~30-80/wk
  { id:'samsmith',      name:'Sam Smith',         emoji:'🎼', sector:'Music',    basePrice:13.00, volatility:0.028, buzzBase:48, buzzDecayRate:0.89 }, // ~10-30/wk
  ...
  { id:'kyliemin',      name:'Kylie Minogue',     emoji:'💫', sector:'Music',    basePrice:18.00, volatility:0.028, buzzBase:40, buzzDecayRate:0.89 }, // ~20-50/wk
  ...
  { id:'justinbieber',  name:'Justin Bieber',     emoji:'🎤', sector:'Music',    basePrice:13.00, volatility:0.038, buzzBase:42, buzzDecayRate:0.90 }, // ~20-60/wk
  ...
  { id:'nickiminaj',    name:'Nicki Minaj',       emoji:'👸', sector:'Music',    basePrice:14.00, volatility:0.055, buzzBase:44, buzzDecayRate:0.91 }, // ~30-80/wk
  { id:'badbunny',      name:'Bad Bunny',         emoji:'🐰', sector:'Music',    basePrice:17.00, volatility:0.040, buzzBase:46, buzzDecayRate:0.91 }, // ~30-80/wk
  { id:'charliexcx',    name:'Charli XCX',        emoji:'⚡', sector:'Music',    basePrice:11.00, volatility:0.045, buzzBase:42, buzzDecayRate:0.91 }, // ~20-60/wk
  { id:'kateperry',     name:'Katy Perry',        emoji:'🐰', sector:'Music',    basePrice:17.00, volatility:0.040, buzzBase:40, buzzDecayRate:0.90 }, // ~20-50/wk
  { id:'yunglean',      name:'Yung Lean',         emoji:'⚡', sector:'Music',    basePrice:11.00, volatility:0.045, buzzBase:42, buzzDecayRate:0.89 }, // ~5-15/wk

  // FILM & TV
  { id:'tomholland',    name:'Tom Holland',       emoji:'🕷️', sector:'Film & TV', basePrice:13.00, volatility:0.032, buzzBase:42, buzzDecayRate:0.90 }, // ~20-60/wk
  { id:'emmastone',     name:'Emma Stone',        emoji:'🎬', sector:'Film & TV', basePrice:20.00, volatility:0.026, buzzBase:40, buzzDecayRate:0.89 }, // ~20-50/wk
  { id:'oliviacolman',  name:'Olivia Colman',     emoji:'🏆', sector:'Film & TV', basePrice:17.50, volatility:0.020, buzzBase:48, buzzDecayRate:0.88 }, // ~10-30/wk
  { id:'idriselba',     name:'Idris Elba',        emoji:'🎭', sector:'Film & TV', basePrice:12.50, volatility:0.024, buzzBase:48, buzzDecayRate:0.89 }, // ~10-30/wk
  { id:'judidench',     name:'Judi Dench',        emoji:'🎩', sector:'Film & TV', basePrice:12.00, volatility:0.022, buzzBase:44, buzzDecayRate:0.88 }, // ~5-20/wk
  { id:'barrykeoghan',  name:'Barry Keoghan',     emoji:'🌟', sector:'Film & TV', basePrice:11.50, volatility:0.038, buzzBase:46, buzzDecayRate:0.89 }, // ~10-30/wk
  { id:'melgibson',     name:'Mel Gibson',        emoji:'🎭', sector:'Film & TV', basePrice:11.00, volatility:0.038, buzzBase:44, buzzDecayRate:0.88 }, // ~5-20/wk
  { id:'ryanreynolds',  name:'Ryan Reynolds',     emoji:'😏', sector:'Film & TV', basePrice:16.00, volatility:0.032, buzzBase:44, buzzDecayRate:0.90 }, // ~30-80/wk
  { id:'margotrobbie',  name:'Margot Robbie',     emoji:'🎬', sector:'Film & TV', basePrice:18.00, volatility:0.030, buzzBase:46, buzzDecayRate:0.91 }, // ~30-80/wk
  ...
  { id:'ryanogosling',  name:'Ryan Gosling',      emoji:'🦢', sector:'Film & TV', basePrice:17.00, volatility:0.028, buzzBase:42, buzzDecayRate:0.90 }, // ~20-60/wk
  { id:'jenniferlawrence',name:'Jennifer Lawrence',emoji:'🏹',sector:'Film & TV', basePrice:14.00, volatility:0.028, buzzBase:48, buzzDecayRate:0.90 }, // ~10-30/wk
  { id:'leonardodicap', name:'Leonardo DiCaprio', emoji:'🎥', sector:'Film & TV', basePrice:20.00, volatility:0.025, buzzBase:42, buzzDecayRate:0.90 }, // ~20-60/wk
  ...
  { id:'willsmith',     name:'Will Smith',        emoji:'👋', sector:'Film & TV', basePrice:12.00, volatility:0.065, buzzBase:40, buzzDecayRate:0.90 }, // ~20-60/wk
  { id:'nicolekidman',  name:'Nicole Kidman',     emoji:'🌺', sector:'Film & TV', basePrice:12.00, volatility:0.022, buzzBase:48, buzzDecayRate:0.89 }, // ~10-30/wk
  { id:'chrishemsworth',name:'Chris Hemsworth',   emoji:'⚡', sector:'Film & TV', basePrice:21.00, volatility:0.030, buzzBase:42, buzzDecayRate:0.90 }, // ~20-50/wk
  { id:'cateblanchett', name:'Cate Blanchett',    emoji:'🏆', sector:'Film & TV', basePrice:14.00, volatility:0.022, buzzBase:48, buzzDecayRate:0.89 }, // ~10-30/wk
  { id:'merylstreep',   name:'Meryl Streep',      emoji:'🎭', sector:'Film & TV', basePrice:12.00, volatility:0.018, buzzBase:44, buzzDecayRate:0.88 }, // ~5-20/wk
  { id:'bradpitt',      name:'Brad Pitt',         emoji:'😎', sector:'Film & TV', basePrice:26.00, volatility:0.035, buzzBase:46, buzzDecayRate:0.90 }, // ~30-80/wk
  { id:'angelinajolie', name:'Angelina Jolie',    emoji:'🌺', sector:'Film & TV', basePrice:25.00, volatility:0.032, buzzBase:44, buzzDecayRate:0.90 }, // ~20-60/wk
  { id:'scarjo',        name:'Scarlett Johansson',emoji:'⚡', sector:'Film & TV', basePrice:27.00, volatility:0.030, buzzBase:44, buzzDecayRate:0.90 }, // ~20-60/wk
  { id:'chrisevans',    name:'Chris Evans',       emoji:'🛡️', sector:'Film & TV', basePrice:15.00, volatility:0.030, buzzBase:48, buzzDecayRate:0.90 }, // ~10-30/wk
  { id:'robertdowney',  name:'Robert Downey Jr',  emoji:'🦾', sector:'Film & TV', basePrice:18.00, volatility:0.035, buzzBase:40, buzzDecayRate:0.89 }, // ~20-50/wk
  { id:'annehathaway',  name:'Anne Hathaway',     emoji:'👒', sector:'Film & TV', basePrice:12.00, volatility:0.026, buzzBase:46, buzzDecayRate:0.89 }, // ~10-20/wk
  { id:'reesewitherspoon',name:'Reese Witherspoon',emoji:'🌸',sector:'Film & TV', basePrice:11.00, volatility:0.025, buzzBase:44, buzzDecayRate:0.89 }, // ~5-20/wk
  { id:'keanugreeves',  name:'Keanu Reeves',      emoji:'🕶️', sector:'Film & TV', basePrice:14.00, volatility:0.025, buzzBase:46, buzzDecayRate:0.90 }, // ~10-30/wk
  ...
  { id:'andymurray',    name:'Andy Murray',       emoji:'🎾', sector:'Sport',    basePrice:17.00, volatility:0.028, buzzBase:42, buzzDecayRate:0.88 }, // ~3-20/wk retired
  { id:'benstokes',     name:'Ben Stokes',        emoji:'🏏', sector:'Sport',    basePrice:12.50, volatility:0.024, buzzBase:48, buzzDecayRate:0.88 }, // ~10-40/wk
  ...
  { id:'usainbolt',     name:'Usain Bolt',        emoji:'⚡', sector:'Sport',    basePrice:12.00, volatility:0.022, buzzBase:40, buzzDecayRate:0.89 }, // ~5-15/wk retired
  { id:'tigerwoods',    name:'Tiger Woods',       emoji:'⛳', sector:'Sport',    basePrice:14.00, volatility:0.038, buzzBase:48, buzzDecayRate:0.89 }, // ~20-60/wk
  { id:'neymar',        name:'Neymar',            emoji:'🇧🇷', sector:'Sport',    basePrice:16.00, volatility:0.048, buzzBase:44, buzzDecayRate:0.90 }, // ~30-80/wk
  { id:'rogerfederer',  name:'Roger Federer',     emoji:'🎾', sector:'Sport',    basePrice:15.00, volatility:0.022, buzzBase:44, buzzDecayRate:0.89 }, // ~10-30/wk retired
  ...
  { id:'anthonyjoshua', name:'Anthony Joshua',    emoji:'🥊', sector:'Sport',    basePrice:22.00, volatility:0.048, buzzBase:40, buzzDecayRate:0.90 }, // ~20-60/wk
  { id:'tysonfury',     name:'Tyson Fury',        emoji:'👊', sector:'Sport',    basePrice:24.00, volatility:0.055, buzzBase:42, buzzDecayRate:0.90 }, // ~20-80/wk
  { id:'stephanicurry', name:'Stephen Curry',     emoji:'🏀', sector:'Sport',    basePrice:26.00, volatility:0.038, buzzBase:48, buzzDecayRate:0.90 }, // ~50-120/wk in season
  { id:'nickdaicos',    name:'Nick Daicos',       emoji:'🎯', sector:'Sport',    basePrice:15.00, volatility:0.035, buzzBase:46, buzzDecayRate:0.89 }, // ~10-30/wk AFL season
  { id:'baileysmith',   name:'Bailey Smith',      emoji:'🏈', sector:'Sport',    basePrice:15.00, volatility:0.035, buzzBase:42, buzzDecayRate:0.88 }, // ~5-20/wk AFL season
  { id:'pepguardiola', name:'Pep Guardiola',      emoji:'⚽', sector:'Sport',    basePrice:15.50, volatility:0.036, buzzBase:40, buzzDecayRate:0.90 },
  
  // POLITICS
  { id:'trump',         name:'Donald Trump',      emoji:'🇺🇸', sector:'Politics', basePrice:35.00, volatility:0.085, buzzBase:50, buzzDecayRate:0.95 }, // ~3000-6000/wk always
  ...
  { id:'princgeorge',   name:'Princess Catherine',emoji:'👸', sector:'Royals',   basePrice:20.00, volatility:0.022, buzzBase:46, buzzDecayRate:0.89 }, // ~50-150/wk
  { id:'queencamilla',  name:'Queen Camilla',     emoji:'👑', sector:'Royals',   basePrice:14.00, volatility:0.018, buzzBase:46, buzzDecayRate:0.88 }, // ~10-40/wk
  { id:'princeandrw',   name:'Prince Andrew',     emoji:'🎖️', sector:'Royals',   basePrice:10.00, volatility:0.060, buzzBase:44, buzzDecayRate:0.88 }, // ~10-40/wk
  { id:'princeedward',  name:'Prince Edward',     emoji:'🎩', sector:'Royals',   basePrice:12.00, volatility:0.015, buzzBase:40, buzzDecayRate:0.87 }, // ~5-15/wk
  { id:'princessanne',  name:'Princess Anne',     emoji:'🐴', sector:'Royals',   basePrice:13.00, volatility:0.015, buzzBase:42, buzzDecayRate:0.88 }, // ~5-20/wk
  ...
  { id:'billgates',     name:'Bill Gates',        emoji:'💻', sector:'Tech',     basePrice:24.00, volatility:0.040, buzzBase:46, buzzDecayRate:0.90 }, // ~50-100/wk
  { id:'timcook',       name:'Tim Cook',          emoji:'🍎', sector:'Tech',     basePrice:16.00, volatility:0.035, buzzBase:40, buzzDecayRate:0.88 }, // ~20-60/wk
  { id:'paloalto',      name:'Jensen Huang',      emoji:'💻', sector:'Tech',     basePrice:20.00, volatility:0.065, buzzBase:46, buzzDecayRate:0.89 }, // ~50-150/wk AI boom
  { id:'jackdorsey',    name:'Jack Dorsey',       emoji:'🐦', sector:'Tech',     basePrice:16.00, volatility:0.045, buzzBase:46, buzzDecayRate:0.89 }, // ~10-40/wk
  { id:'serjobrin',     name:'Sergey Brin',       emoji:'🔍', sector:'Tech',     basePrice:18.00, volatility:0.040, buzzBase:42, buzzDecayRate:0.88 }, // ~5-20/wk
]
