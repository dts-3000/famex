    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
      ...
      {realNews.length > 0 && (
        <div style={{
          ...
          📡 {realNews.length} live headlines from Google News · buzz scores updated from real mentions
        </div>
      )}
