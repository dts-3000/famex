...
export default function CelebCard({ celeb, price, history, buzz, holding, onBuy, onSell }) {
    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', gap: '10px' }}>
        ...
        <div style={{ textAlign: 'right', flexShrink: 0 }}>
          <div style={{ fontFamily: 'var(--font-mono)', fontWeight: 500, fontSize: 16, color: 'var(--text)' }}>{fmt(price)}</div>
          <div style={{
      ...
      <div style={{ borderRadius: 6, overflow: 'hidden' }}>
        <Sparkline data={histData} isUp={isUp} width={260} height={40} />
      </div>

      {/* Buzz bar */}
      <div>
        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 5 }}>
          <span style={{ fontSize: 10, color: 'var(--text3)', fontFamily: 'var(--font-mono)', textTransform: 'uppercase', letterSpacing: '0.08em' }}>Media buzz</span>
          <span style={{ fontSize: 10, color: 'var(--text2)', fontFamily: 'var(--font-mono)' }}>{Math.round(buzz)}/100</span>
        </div>
