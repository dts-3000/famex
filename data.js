export const CELEBRITIES = [
  { id:'tayswift',      name:'Taylor Swift',     emoji:'🎤', sector:'Music',    basePrice:120, volatility:0.035, buzzBase:70, buzzDecayRate:0.92 },
  { id:'beyonce',       name:'Beyoncé',           emoji:'👑', sector:'Music',    basePrice:180, volatility:0.030, buzzBase:70, buzzDecayRate:0.91 },
  { id:'adele',         name:'Adele',             emoji:'🎵', sector:'Music',    basePrice:190, volatility:0.025, buzzBase:70, buzzDecayRate:0.90 },
  { id:'edsheeran',     name:'Ed Sheeran',        emoji:'🎸', sector:'Music',    basePrice:160, volatility:0.028, buzzBase:70, buzzDecayRate:0.90 },
  { id:'dualipa',       name:'Dua Lipa',          emoji:'💃', sector:'Music',    basePrice:140, volatility:0.032, buzzBase:70, buzzDecayRate:0.91 },
  { id:'samsmith',      name:'Sam Smith',         emoji:'🎼', sector:'Music',    basePrice:190, volatility:0.028, buzzBase:68, buzzDecayRate:0.89 },
  { id:'tomholland',    name:'Tom Holland',       emoji:'🕷️', sector:'Film & TV', basePrice:130, volatility:0.032, buzzBase:76, buzzDecayRate:0.90 },
  { id:'emmastone',     name:'Emma Stone',        emoji:'🎬', sector:'Film & TV', basePrice:100, volatility:0.026, buzzBase:70, buzzDecayRate:0.89 },
  { id:'oliviacolman',  name:'Olivia Colman',     emoji:'🏆', sector:'Film & TV', basePrice:115, volatility:0.020, buzzBase:65, buzzDecayRate:0.88 },
  { id:'idriselba',     name:'Idris Elba',        emoji:'🎭', sector:'Film & TV', basePrice:115, volatility:0.024, buzzBase:67, buzzDecayRate:0.89 },
  { id:'judidench',     name:'Judi Dench',        emoji:'🎩', sector:'Film & TV', basePrice:160, volatility:0.016, buzzBase:62, buzzDecayRate:0.87 },
  { id:'barrykeoghan',  name:'Barry Keoghan',     emoji:'🌟', sector:'Film & TV', basePrice:115, volatility:0.038, buzzBase:64, buzzDecayRate:0.89 },
  { id:'lewishamilton', name:'Lewis Hamilton',    emoji:'🏎️', sector:'Sport',    basePrice:145, volatility:0.036, buzzBase:77, buzzDecayRate:0.90 },
  { id:'davebeckham',   name:'David Beckham',     emoji:'⚽', sector:'Sport',    basePrice:160, volatility:0.028, buzzBase:74, buzzDecayRate:0.89 },
  { id:'bukayosaka',    name:'Bukayo Saka',       emoji:'🦊', sector:'Sport',    basePrice:110, volatility:0.038, buzzBase:78, buzzDecayRate:0.90 },
  { id:'bellingham',    name:'Jude Bellingham',   emoji:'⚽', sector:'Sport',    basePrice:135, volatility:0.042, buzzBase:82, buzzDecayRate:0.91 },
  { id:'andymurray',    name:'Andy Murray',       emoji:'🎾', sector:'Sport',    basePrice:110, volatility:0.028, buzzBase:68, buzzDecayRate:0.88 },
  { id:'benstokes',     name:'Ben Stokes',        emoji:'🏏', sector:'Sport',    basePrice:115, volatility:0.024, buzzBase:65, buzzDecayRate:0.88 },
  { id:'caitlinclark',  name:'Caitlin Clark',     emoji:'🏀', sector:'Sport',    basePrice:115, volatility:0.048, buzzBase:83, buzzDecayRate:0.91 },
  { id:'maxverstappen', name:'Max Verstappen',    emoji:'🏁', sector:'Sport',    basePrice:120, volatility:0.038, buzzBase:76, buzzDecayRate:0.90 },
  { id:'keirmstarmer',  name:'Keir Starmer',      emoji:'🏛️', sector:'Politics', basePrice:140, volatility:0.048, buzzBase:80, buzzDecayRate:0.90 },
  { id:'trump',         name:'Donald Trump',      emoji:'🇺🇸', sector:'Politics', basePrice:150, volatility:0.085, buzzBase:30, buzzDecayRate:0.95 },
  { id:'albanese',      name:'Anthony Albanese',  emoji:'🇦🇺', sector:'Politics', basePrice:130, volatility:0.042, buzzBase:30, buzzDecayRate:0.89 },
  { id:'nigelfar',      name:'Nigel Farage',      emoji:'🍺', sector:'Politics', basePrice:120, volatility:0.065, buzzBase:30, buzzDecayRate:0.90 },
  { id:'princewilliam', name:'Prince William',    emoji:'🎩', sector:'Royals',   basePrice:110, volatility:0.020, buzzBase:72, buzzDecayRate:0.89 },
  { id:'harryprince',   name:'Prince Harry',      emoji:'🤴', sector:'Royals',   basePrice:115, volatility:0.055, buzzBase:82, buzzDecayRate:0.91 },
  { id:'elonmusk',      name:'Elon Musk',         emoji:'🚀', sector:'Tech',     basePrice:110, volatility:0.075, buzzBase:92, buzzDecayRate:0.93 },
]
